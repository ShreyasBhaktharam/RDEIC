...
VGG_LPIPS_PRETRAIN_PATH = './weight/lpips/vgg.pth'
ALEX_LPIPS_PRETRAIN_PATH = './weight/lpips/alex.pth'
...
class LPIPS(nn.Module):
    ...
    def __init__(self,
        ...
        if (self.pnet_type in ['vgg', 'vgg16']):
            ...
            net_type = alexnet
            self.chns = [64, 192, 384, 256, 256] # alex features
...
class vgg16(torch.nn.Module):
    ...
    def __init__(self, pretrained=True, requires_grad=False):
        ...
        vgg_pretrained = models.vgg16(pretrained=pretrained)
